...
题目链接：[[732. 我的日程安排表 III - 力扣（LeetCode）](https://leetcode.cn/problems/my-calendar-iii/description/)](https://leetcode.cn/problems/my-calendar-ii/description/)

题目难度：困难

题目标签：设计、线段树、二分查找、有序集合、前缀和
